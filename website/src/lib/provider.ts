...
// Default canary testnet chain (88780). 18780 was decommissioned 2026-05-12.
...
/** Server-side JSON-RPC uses PALI_RPC_URL; client uses NEXT_PUBLIC_RPC_URL (falls back to localhost when unset). */
